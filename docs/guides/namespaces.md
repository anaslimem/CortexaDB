...
- [Core Concepts](./core-concepts.md) - How namespaces fit into the architecture
- [Query Engine](./query-engine.md) - How namespace scoping affects queries
- [Python API](../api/python.md) - Namespace API reference
